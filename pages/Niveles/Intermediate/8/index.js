    ...
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="font-bold text-gray-700">
          ...
          (walking, eating, etc.). Como hemos visto en la lección sobre los verbos, el infinitivo se forma con la
          preposición “to” (to walk, to eat, etc.).
        </p>
        <div className="my-4">
          <div className="space-y-2">
            <SingleExample english="He began doubting himself." spanish="Comenzó a dudar de sí mismo." />
            <SingleExample
              english="They decided to move to Australia in May."
              spanish="Decidieron mudarse a Australia en Mayo."
            />
            <SingleExample english="I enjoy listening to music." spanish="Disfruto escuchando música." />
            <SingleExample english="She hates studying. / She hates to study." spanish="Odia estudiar." />
            <SingleExample english="You love dancing. / You love to dance." spanish="Te encanta bailar." />
            <SingleExample
              english="
...
She continued working. / She continued to work."
            ...
            />
            <SingleExample english="Swimming is good exercise." spanish="Nadar es un buen ejercicio" />
            <SingleExample english="Drinking and driving is dangerous." spanish="Beber y conducir es peligroso." />
            <SingleExample
              english="My favorite exercise is swimming."
              spanish="Mi ejercicio favorito es la natación."
            />
            <SingleExample english="He’s good at listening." spanish="El Escucha bien." />
            <SingleExample english="I always read before going to bed." spanish="Siempre leo antes de acostarme." />
            <SingleExample
              english="You can’t leave without saying goodbye."
              spanish="No puedes salir sin despedirte."
            />
            <SingleExample english="What is the advantage of waiting?" spanish="¿Cuál es la ventaja de esperar?" />
          </div>

  ...
  return (
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <VideoPlayer url={'https://www.youtube.com/watch?v=xzui11Tl578'} />
        <p className="font-bold text-gray-700">
          Utilizamos los pronombres relativos para referirnos a un sustantivo (una persona o una cosa) mencionado antes
          y al que queremos agregar más información o modificar. Los pronombres relativos pueden referirse a algo o
          alguien en singular o plural. Algunos pronombres relativos se pueden usar sólo con personas, otros sólo con
          cosas y algunos con ambos. A continuación, tienes una lista de los pronombres relativos.
        </p>
        <div className="my-4">
          <div className="space-y-2">
            <p className="text-gray-400 font-bold text-base">EJEMPLO:</p>
            <SingleExample english="that" spanish="que" />
            <SingleExample english="which" spanish="que / cual" />
            <SingleExample english="who" spanish="que / quién" />
            <SingleExample english="whom" spanish="que / a quien" />
            <SingleExample english="whose" spanish="cuyo" />
            <p className="text-gray-400 font-bold text-base">EJEMPLOS:</p>
            <SingleExample

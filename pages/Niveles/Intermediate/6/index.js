  ...
  return (
    <div className='bg-gray-100'>
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <p className='font-bold text-gray-700'>Los intensificadores y mitigadores se usan para variar el grado o fuerza de un adjetivo, verbo o adverbio.</p>
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            <SingleExample
              english="amazingly"
              spanish="sorprendentemente" />
            <SingleExample
              english="enough"
              spanish="suficiente" />
            <SingleExample
              english="Kate is really beautiful."
              spanish="Kate es verdaderamente guapa." />
            <SingleExample
              english="Michael can run very fast."
              spanish="Michael puede correr muy rápido." />
            <SingleExample
            ...
            <SingleExample
              english="Dave is much faster than me."
              spanish="Dave es mucho más rápido que yo." />
            <SingleExample
            ...
            <p className='font-bold text-gray-700'>Mientras los intensificadores refuerzan el sentido de un adjetivo, los mitigadores los debilitan.</p>
            <SingleExample
              english="fairly"
              spanish="bastante" />
            <SingleExample
            ...
            <SingleExample
              ...
              spanish="bastante" />
            <SingleExample
              english="The movie was fairly boring."
              spanish="La película era bastante aburrida." />
            <SingleExample
              english="The students were rather quiet in class."
              spanish="Los estudiantes eran bastante tranquilos en clase." />
            <SingleExample
              english="It’s a pretty nice day."
              spanish="Es un día bastante bonito." />
            <SingleExample
              english="Dave is a bit faster than me."
              spanish="Dave es un poco más rápido que yo." />
            <SingleExample

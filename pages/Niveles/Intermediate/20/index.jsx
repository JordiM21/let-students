  ...
  return (
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <VideoPlayer url={'https://www.youtube.com/watch?v=O1iknZF-sk0'} />
        <p className="font-bold text-gray-700">
          Escucha atentamente la historia de Ken y Louis, escucha las veces que quieras y fijate bien en lo que hacen.
          Luego responde las preguntas abajo
        </p>
        <div className="my-4">

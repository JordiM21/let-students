  ...
  return (
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <VideoPlayer url={'https://www.youtube.com/watch?v=OWuFkCPb9oE'} />
        <p className="font-bold text-gray-700">
          El verbo “use” significa “usar” o “utilizar”. Sin embargo, cuando utilizamos este verbo en el pasado simple,
          más la preposición “to”, como verbo modal, el significado cambia. Además, se puede utilizar “used to” como
          adjetivo. A continuación tienes una explicación de los diferentes usos.
        </p>
        <div className="my-4">
          <div className="space-y-2">
            <CustomTitle title="Used to" titleSpanish="Soler" />
            <p className="font-bold text-gray-700">
              Esta frase es genial, usala para sonar como todo un nativo! Usamos el verbo modal “used to” para indicar
              algo que ocurría o sucedía en el pasado de manera habitual. También, se utiliza para algo que antes era
              verdad pero ya no lo es. Como con los otros verbos modales, “used to” está seguido por la forma base del
              verbo (el infinitivo sin “to”).
            </p>
            <SingleExample english="I used to play videogames" spanish="Yo solía jugar videojuegos" />
...
I didn’t use to like mushrooms, but now I do."
            ...
            />
            <SingleExample english="Food didn’t use to be so expensive." spanish="La comida no solía ser tan cara." />
            <SingleExample english="Did you use to live here?" spanish="¿Vivías aquí antes?" />
            <SingleExample
            ...
            <p className="font-bold text-gray-700">
              STOP THERE! tengo otro secreto para ti, no se si lo recuerdas pero vengo a recordarte que las palabras
              terminadas en -ly como usually y normally se traduce siempre con lly = mente. Entonces normal = normal /
              normally = normalmente || usual = usual / usually = usualmente, QUE FAAAACIIIL
            </p>
            <SingleExample

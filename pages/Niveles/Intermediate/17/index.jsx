    ...
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="font-bold text-gray-700">
          Escucha el video atentamente y mira las palabras subrayadas en rojo y entiende el contexto. Para formar el
          futuro continuo se utilizan “will be” o “be going to” y el verbo+ing.
        </p>
        <div className="my-4">
...
I will be talking. / I’m going to be talking."
            ...
            />
            <p className="font-bold text-gray-700">
              Te lo puedo explicar sencillo como: La frase yo voy a estar + verbo (ando, endo) ejemplo: estaré
              trabajando (i will be working) que con going to es lo mismo pero decimos yo voy a estar trabajando (i am
              going to be working)
            </p>
            <SingleExample english="He will be eating. / He’s going to be eating." spanish="El estará comiendo" />
            <SingleExample
...
I will not [won’t] be talking. / I’m not going to be talking."
            ...
            />
            <SingleExample english="Will you be talking? / Are you going to be talking?" spanish="¿Estarás hablando?" />
            <SingleExample
              english="

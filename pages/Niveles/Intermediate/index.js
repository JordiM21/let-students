...
const Intermediate = ({ levelData, userData }) => {
  ...
  return (
    <div className="bg-[var(--bluebg)] py-24">
      ...
      <BackHeader largeTitle="Intermediate" parentTitle="Volver" />
      <div className="md:w-2/5 mx-auto space-y-4 mb-8 md:mx-8 max-md:w-10/12 md:fixed bg-[var(--bluebg)]">
        ...
        <h3 className="text-2xl font-bold text-white">
          Curso intermedio de inglés para los que dominan los conceptos básicos del lenguaje.
        </h3>
        <p className="text-[var(--lightBlue)] opacity-60">
          El curso intermedio es para los que dominan los conceptos básicos del lenguaje. Al finalizar este curso, el
          estudiante será capaz de entender y formar oraciones más complejas y comunicarse en inglés con mayor
          confianza.
        </p>
      </div>

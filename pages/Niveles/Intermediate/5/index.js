  ...
  return (
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <VideoPlayer url={'https://www.youtube.com/watch?v=3C49nBmsVbI'} />
        <p className="font-bold text-gray-700">
          Como hemos visto, los adjetivos describen cualidades de sustantivos. Algunas de estas cualidades pueden variar
          en el grado o intensidad. Al igual que en español, cuando queremos hacer comparaciones contrastamos cualidades
        ...
        <div className="my-4">
          <div className="space-y-2">
            ...
            <SingleExample english="Juan runs faster than Mark." spanish="Juan corre más rápido que Mark." />
            <SingleExample
              english="Angela’s room is cleaner than Sue’s."
              spanish="La habitación de Angela está más limpia que la de Sue."
            />
            <SingleExample english="I am taller than Beth." spanish="Soy más alto que Beth." />
            <SingleExample
              english="
New York is bigger than Los Angeles."
            ...
            />
            <p className="font-bold text-gray-700">
              2. Comparativos de inferioridad. Para formar este tipo de comparación podemos usar las conjunciones “not
              as…as” or “less…than”. En ambos casos, el adjetivo está en el grado positivo.
            </p>
            <SingleExample english="Mark is not as fast as Juan." spanish="Mark no corre tan rápido como Juan." />
            <SingleExample
              english="Sue’s room is less clean than Angela’s."
              spanish="La habitación de Sue no es tan limpia como la de Angela."
            />
            <SingleExample english="Beth is not as tall as me." spanish="Beth no es tan alta como yo." />
            <SingleExample
            ...
            <SingleExample english="Mark is as fast as Juan." spanish="Mark corre tan rápido como Juan." />
            <SingleExample
              english="Sue’s room is as clean as Angela’s."
              spanish="La habitación de Sue es tan limpia como la de Angela."
            />
            <SingleExample english="Beth is as tall as I am." spanish="Beth es tan alta como yo." />
            <SingleExample
              english="

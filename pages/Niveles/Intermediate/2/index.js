      ...
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            <SingleExample
              english="Another glass of wine please."
              spanish="Otra copa de vino por favor." />
            <SingleExample
              english="any"
              spanish="algun, ningun, cualquier" />
            <SingleExample
              english="Is there any milk?"
              spanish="¿Hay leche?" />
            <SingleExample
              english="anybody / anyone"
              spanish="alguien, nadie, cualquiera" />
            <SingleExample
              english="Is there anyone home?"
              spanish="¿Hay alguien en casa?" />
            <SingleExample
              english="anything"
              spanish="algo, nada,
cualquier" />
            ...
            <SingleExample
              english="anywhere"
              spanish="cualquier lugar" />
            <SingleExample
              english="We can go anywhere you want."
              spanish="Podemos ir donde quieras." />
            <SingleExample
              english="both"
              spanish="ambos/los dos" />
            <SingleExample
              english="Both of my children speak French."
              spanish="Mis dos hijos hablan francés." />
            <SingleExample
              english="each"
              spanish="cada, cada uno" />
            <SingleExample
              english="Each of them is different."
              spanish="cada uno de ellos es diferente" />
            <SingleExample
              english="either"
              spanish="cualquiera
(de 2)" />
            <SingleExample
              english="I’m happy to see either movie."
              spanish="Me da igual ver cualquier película." />
            <SingleExample
              english="enough"
              spanish="suficiente" />
            <SingleExample
              english="There is never enough time."
              spanish="Nunca hay tiempo suficiente" />
            <SingleExample
              english="every"
              spanish="cada, todos" />
            <SingleExample
            ...
            <SingleExample
              ...
              spanish="todos, todo el mundo" />
            <SingleExample
              english="Everybody know it!"
              spanish="todos lo conocen!" />
            <SingleExample
              english="everything"
              spanish="todo" />
            <SingleExample
              english="How’s everything? Everything is fine."
              spanish="¿Qué tal todo? Todo bien." />
            <SingleExample
              english="everywhere"
              spanish="todas partes" />
            <SingleExample
              english="The water spilled everywhere."
              spanish="El agua se derramó por todas partes." />
            <SingleExample
              english="few"
              spanish="pocos, unos" />
            <SingleExample
              english="He has few friends."
              spanish="Él tiene pocos amigos." />
            <SingleExample
              english="less"
              spanish="menos" />
            <SingleExample
              english="There is less work this year."
              spanish="Hay menos trabajo este año." />
            <SingleExample
              english="more"
              spanish="más" />
            <SingleExample
              english="There is more work this year."
              spanish="Hay más trabajo este año." />
          </div>

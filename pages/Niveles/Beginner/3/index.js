    ...
    <div className="mx-6 md:max-w-xl md:mx-auto">
      ...
      <div className="my-4">
        ...
        <div className="space-y-4">
          ...
          <p className="font-bold text-gray-700">
            Ahora sabemos como señalar 1 objeto estando lejos o cerca, el referente para saber si decir "this" or "that"
            es comunmente si lo puedo tocar "this" y si está lejos a la distancia digo "that" simple no? PERO ahora
            veamos como decimos más de un objeto:
          </p>
          ...
          <p className="font-bold text-gray-700">
            Estos ultimos dos ejemplos serían con objetos a diversas distancias, igual aplica la regla de si lo puedo
            tocar digo "these" y si no digo "those", así de simple!
          </p>
          ...
          <p className="text-sm opacity-60 mt-8">
            Me gusta este carro que está aquí, es decir lo puedo tocar o es facilmente alcanzable.
          </p>
          <SingleExample english="I like that car" spanish="Me gusta ese coche/carro." />
          <p className="text-sm opacity-60 mt-8">
            Me gusta ese carro que está allí/allá, es decir está alejado de mi posición
          </p>

    ...
    <div className="mx-6 md:max-w-xl md:mx-auto">
      ...
      <div className="my-4">
        ...
        <div className="space-y-4">
          <DoubleExample english1="my" english2="This is my house." spanish1="mi(s)" spanish2="Ésta es mi casa." />
          <DoubleExample
            english1="your"
          ...
          <DoubleExample english1="My book" english2="My books" spanish1="Mi libro" spanish2="Mis libros" />
          <DoubleExample english1="Your book" english2="Your books" spanish1="tu libro" spanish2="tus libros" />
          <p className="text-[var(--color2)] font-bold text-lg opacity-75">EXAMPLES:</p>
          <SingleExample english="My car is blue." spanish="Mi coche/carro es azul." />
          <SingleExample english="His house is big" spanish="Su (hombre) casa es grande" />
          <SingleExample english="Her friend is kind" spanish="Su (mujer) amiga es amigable" />
          <SingleExample english="The blue car is mine" spanish="El carro azul es mío" />
          <SingleExample english="The big house is his" spanish="La casa grande es suya. (hombre)" />
          ...
          <CustomTitle
            title="Possessive Pronouns vs. the Genitive Case"
            titleSpanish="Pronombres posesivos y el genitivo"
          />
          <p className="font-bold opacity-75">
            El genitivo por dificil que suene es solo agregar una “-s” al final de un sujeto para decir que es el
            propietario del siguiente sustantivo, no te quiero confundir, ¡mira los ejemplos!:
          </p>
          <SingleExample english="Her dress…" spanish="Su vestido... [de ella]" />
          <p className="text-sm font-bold opacity-75">O podemos usar el genitivo "-s"</p>
          <SingleExample english="Andrea’s dress…" spanish="El vestido de Andrea" />
          <SingleExample english="Giuseppe's Pizzeria" spanish="La pizzeria de giuseppe" />
          <SingleExample english="My friend's car" spanish="El carro de mi amigo" />
          <p className="text-sm font-bold opacity-75">
            Es muy importante que recuerdes que el genitivo "-s" solo lo usamos con personas:
          </p>

          <SingleExample english="Paul's house..." spanish="La casa de Paul" />
          <p className="text-sm font-bold opacity-75">
            Cuando nos referimos a cosas o lugares que pertenecen a otra cosa usamos "of":
          </p>
          <SingleExample english="The wheel of the bike…" spanish="La rueda de la bicicleta…" />
          <SingleExample
            english="
          ...
          <p className="text-[var(--color2)] font-bold text-lg opacity-75">EXAMPLES:</p>
          <SingleExample english="Luis' house" spanish=" La casa de Luis.." />
          <SingleExample english="The students’ exams…" spanish="los exámenes de los estudiantes…" />
        </div>

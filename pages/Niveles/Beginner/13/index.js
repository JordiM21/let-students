  ...
  return (
    <div className='mx-6 md:max-w-xl md:mx-auto'>
      ...
      <ReactPlayer
        ...
        controls={true} />
      <div className='my-4'>
        <p className='font-bold text-sm opacity-90'>Las preguntas con WH son muy sencillas y forman parte de los dos tipos de pregunta en inglés, tenemos las preguntas con respuesta sí o no, por ejemplo: Do you like coffe?/¿Te gusta el café? esta pregunta es una Yes/No question. Pero en esta lección hablaremos de las WH Questions que es el segundo tipo de pregunta mejor conocida como PREGUNTAS ABIERTAS</p>
        <div className='space-y-4'>
          <p className='text-[var(--blueDarkbg)] text-3xl font-bold'>Wh - Questions</p>
          <SingleExample
            english="Who"
            spanish="Quien (persona)"
          />
          <SingleExample
            english="What"
            spanish="Que (cosa)"
          ...
          />
          <SingleExample
            english="Where do you like?"
            spanish="¿Donde vives tu?"
          />
          <SingleExample
            english="Where does she live?"
            spanish="¿Donde vive ella?"
          />
          <SingleExample
            english="Why are you here?"
            spanish="¿Por que estás aquí?"
          />
          <SingleExample
            english="How are you?"
            spanish="¿Como estás?"
          />
          <SingleExample
            english="What is her favorite movie?"
            spanish="¿Cual es su (ella) película favorita?"
          />
          <SingleExample
          ...
          <SingleExample
            ...
            spanish="¿Cuando es tu cumpleaños?"
          />
          <SingleExample
            english="When do you have class?"
            spanish="¿Cuando tienes clase?"
          />
          <p className='text-[var(--blueDarkbg)] text-3xl font-bold'>WHICH</p>
          <p>Utilizamos Which que también es un WH Question pero es particularmente diferente porque se usa SOLO cuando se tienen pocas opciones a elegir (en general 2) entonces, cuando tenemos que decidir una opción usamos "which"</p>
          ...
          />
          <SingleExample
            english="What is your favorite ice cream?"

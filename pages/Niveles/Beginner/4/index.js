  ...
  return (
    <div className="mx-6 md:max-w-xl md:mx-auto">
      ...
      <p className="font-bold text-gray-700">
        Los pronombres reflexivos se usan cuando el sujeto y el complemento del verbo son lo mismo. El sujeto hace la
        acción a sí mismo. En inglés no se utilizan los verbos reflexivos tanto como en español. En vez de verbos
      ...
      <div className="my-4">
        ...
        <div className="space-y-4">
          ...
          <p className="font-bold opacity-75 text-sm">
            Usamos “by” + el pronombre reflexivo para indicar “solo”. A menudo cuando queremos enfatizar que una acción
            la realizamos sin ninguna persona o ayuda.
          </p>
          <SingleExample
            english="
          I often prefer to be by myself."
            spanish="A menudo prefiero estar solo."
          />
          <SingleExample
            english="
          She learned to read all by herself."
            spanish="Ella aprendió a leer por sí misma."
          />
          ...
          <SingleExample
            english="What a great party! Did you prepare everything yourself?"
            spanish="¡Qué gran fiesta! ¿Lo preparaste todo tú mismo?"
          />
          <SingleExample
            english="I cooked all of this by myself"
            spanish="Yo preparé todo esto yo solo [por mi cuenta]"
          />
        </div>

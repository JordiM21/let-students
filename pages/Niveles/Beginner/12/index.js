    ...
    <div className="mx-6 md:max-w-xl md:mx-auto">
      ...
      <div className="my-4">
        <p className="font-bold text-sm opacity-90">
          ...
          verbos auxiliares “be”, “do” y “have” que sí pueden funcionar como un verbo principal. Los verbos modales
          expresan modalidad, habilidad, posibilidad, necesidad u otra condición. Los utilizamos para el futuro y el
          condicional.
        </p>
        <div className="space-y-4">
          <p className="text-gray-600 font-bold text-xl">EJEMPLOS:</p>
          <p className="text-[var(--blueDarkbg)] text-3xl font-bold">CAN</p>
          <SingleExample english="I Can speak two languages" spanish="Puedo hablar cinco idiomas." />
          <SingleExample
            english="We can work late tonight if you need us."
            spanish="Podemos trabajar hasta tarde esta noche si nos necesitas."
          />
          <SingleExample english="Bill and Tom can’t help you." spanish="Bill y Tom no pueden ayudarte." />
          <SingleExample
          ...
          <SingleExample english="Can i go to the bathroom?" spanish="¿Puedo ir al baño?" />
          <SingleExample english="Can you help me?" spanish="¿Puedes (tú) ayudarme (a mi)?" />
          <SingleExample english="Can they work late tonight?" spanish="¿Pueden trabajar hasta tarde esta noche?" />
          <p className="text-[var(--blueDarkbg)] text-3xl font-bold">MAY</p>
          <p>
            El mismo uso de "can" pero, se utiliza en ocasiones mas formales para pedir permisos y para expresar
            posibilidades de las cuales no estamos muy seguros en el futuro
          </p>
          <SingleExample english="It may rain later" spanish="Puede que llueva mas tarde (No estamos seguros)" />
          <SingleExample english="You may be on a problem" spanish="Podrías estar en un problema (Posibilidad)" />
          <p>Uso con permisos o instrucciones:</p>
          <SingleExample english="Mom, may i go out?" spanish="Madre, ¿puedo salir?" />
          <SingleExample english="Yo may use your phone now" spanish="Pueden usar sus teléfonos ahora" />
          <SingleExample english="May i have a glass of water?" spanish="¿Podría tomar un vaso de agua?" />
          ...
          <SingleExample english="May i go to the bathroom?" spanish="¿Podría ir al baño? (Muy formal)" />
          ...
          <p className="text-gray-600 font-bold text-xl">EJEMPLOS:</p>
          <SingleExample english="Joe could run very fast" spanish="Joe podía correr muy rapido (antes, ahora no)" />
          <SingleExample english="I could not/couldn't sleep last night" spanish="Yo no pude dormir anoche" />
          <p>Tambien usamos could en frases interrogativas para preguntar posibilidades y solicitar permisos</p>
          <SingleExample english="Could you pass the salt please?" spanish="¿Podrías pasarme la sal por favor?" />
          <SingleExample english="Could you help me?" spanish="¿Podrías ayudarme?" />
          <SingleExample english="Could i be wrong?" spanish="¿Podría estar equivocado?" />
          <SingleExample english="Could you teach me math?" spanish="¿Podrías enseñarme matemáticas?" />
          <p className="text-[var(--blueDarkbg)] text-3xl font-bold">MIGHT</p>
          <p>
            Sinónimo de "may" para indicar posibilidades (Es mucho mas comun en Reino Unido que en Estados unidos) y
            también es muy formal
          </p>
          <SingleExample english="it might rain later." spanish="puede que llueva mas tarde" />
          <SingleExample english="it might be a good idea" spanish="eso puede ser una buena idea" />
          ...
          />
          <SingleExample english="You shouldn’t work so hard." spanish="No debería trabajar tan duro." />
          <SingleExample
          ...
          />
          <SingleExample english="Should we leave a tip?" spanish="¿Deberíamos dejar una propina?" />
          <SingleExample
            english="Should I have the steak or the chicken?"
            spanish="¿Debería comer el bistec o el pollo?"
          />
          <SingleExample english="Where should they meet you?" spanish="¿Dónde deberían encontrarte?" />
          <p className="text-[var(--blueDarkbg)] text-3xl font-bold">
          ...
          />
          <SingleExample english="You must not drink and drive." spanish="No puedes beber y conducir." />
          <SingleExample english="When must we meet you?" spanish="¿Cuándo debemos quedar? " />
          ...
          />
          <SingleExample english="I would like a beer " spanish="Me gustaría una cerveza" />
          <SingleExample english="Would you like some coffee?" spanish="¿Le gustaría un cafe?" />
          ...
          <SingleExample english="Would you help me please?" spanish="¿Me ayudarías por favor?" />
          <SingleExample
            english="

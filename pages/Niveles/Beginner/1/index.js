  ...
  return (
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="opacity-60 font-bold text-lg text-[var(--color2)]">Pronouns - LESSON 1.1</p>
        ...
        <VideoPlayer url={'https://www.youtube.com/watch?v=cVkSndpZtN0'} />
        <p className="font-bold text-gray-700">
          Dentro de los pronombres personales, la lengua inglesa distingue entre pronombres en función de sujeto
          (subject pronouns) y pronombres en función de objeto (object pronouns).
        </p>
        <div className="my-4">
          <small className="text-sm opacity-60">
            Pronombres (En función de sujeto) osea que, ¡reemplazan a el sujeto!
          </small>
          <div className="space-y-2">
            <DoubleExample english1="I" english2="I am Ill." spanish1="Yo" spanish2="Yo estoy enfermo" />
            <DoubleExample
              english1="You"
              spanish1="tú, usted"
            ...
            />
            <DoubleExample english1="He" spanish1="él" english2="He is handsome" spanish2="él es guapo" />
            <DoubleExample english1="She" spanish1="ella" english2="She is pretty" spanish2="Ella es bonita" />
            <DoubleExample
              english1="It"
              spanish1="eso (cosa)"
            ...
            />
            <small className="text-center opacity-80 font-semibold">
              Pronombres (En función de objeto) osea que, ¡reemplazan a el objeto!
            </small>
            <p className="text-gray-600 font-bold text-xl">EJEMPLO</p>
            <DoubleExample english1="me" spanish1="mi" english2="Can you help me?" spanish2="¿Puedes ayudarme?" />
            <DoubleExample
              english1="you"
            ...
            />
            <DoubleExample english1="him" spanish1="a él" english2="Can you see him?" spanish2="¿Puedes ver a él?" />
            <DoubleExample english1="her" spanish1="a ella" english2="Give it to her." spanish2="Dáselo a ella." />
            <DoubleExample english1="it" spanish1="a eso" english2="Give it a kick" spanish2="Dale una patada" />
            <DoubleExample
              english1="us"
              spanish1="a nosotros"
            ...
            />
            <DoubleExample english1="them" spanish1="a ellos" english2="He can help them" spanish2="Les puede ayudar" />
            ...
            <p className="font-bold text-gray-700">
              Los pronombres en inglés distinguen entre masculino (he), femenino (she) y neutro (it). <br />
            ...
            <SingleExample english="Where is it? [the book]" spanish="(¿Dónde está? [el libro])" />
            <SingleExample english="What time is it? [the book]" spanish="(¿Qué hora es?)" />
            <SingleExample english="It is raining" spanish="(Esta lloviendo.)" />

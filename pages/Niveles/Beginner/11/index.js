  ...
  return (
    <div className='mx-6 md:max-w-xl md:mx-auto'>
      ...
      <ReactPlayer
        ...
        url="https://www.youtube.com/watch?v=uQWgJGHwF0Y"
        controls={true} />
      <div className='my-4'>
        <p className='font-bold text-xs opacity-90'>El verbo “to be” es el verbo más importante del inglés y al mismo tiempo, el más complicado. Se utiliza tanto como un verbo principal como un verbo auxiliar y es irregular en el presente y el pasado.</p>
        <div className='space-y-4'>
          ...
          <SingleExample
            ...
            spanish="yo no soy/yo estoy"
          />
          <SingleExample
            english="you are not / you aren't"
            spanish="tú no eres/estás"
          />
          <SingleExample
          ...
          <p className='text-gray-600 font-bold text-xl'>EJEMPLOS:</p>
          <SingleExample
            english="I am teacher"
            spanish="Soy un profesor"
          />
          <SingleExample
            english="You aren't a student"
            spanish="Tu no eres un estudiante"
          />
          <SingleExample
            english="Is he a doctor?"
            spanish="¿Es el un doctor?"
          />
          <SingleExample
            english="She is in New York"
            spanish="Ella está en Nueva York"
          />
          <SingleExample
          ...
          />
          <SingleExample
            english="He isn't sad"
            spanish="El no está triste"
          />
          <SingleExample

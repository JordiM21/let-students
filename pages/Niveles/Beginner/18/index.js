    ...
    <div className='mx-6 md:max-w-xl md:mx-auto'>
      ...
      <div className='my-4'>
        ...
        <div className='space-y-4'>
          <SingleExample
            english="Mess"
            spanish="desorden / desastre"
          />
          <SingleExample
            english="Tidy"
            spanish="ordenar / ordenado"
          />

          <SingleExample
            english="This house is a mess"
            spanish="Esta casa es un desastre"
          />
          <SingleExample
            english="Where are you going?"
            spanish="¿Donde estás andando?"
          />
          <SingleExample
            english="better"
            spanish="mejor"
          ...
          <SingleExample
            ...
            spanish="levantarse / alzarse de la cama"
          />
          <SingleExample
            english="Usually"
            spanish="usualmente"

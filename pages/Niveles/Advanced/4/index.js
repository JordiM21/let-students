      ...
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <div className="my-4">
          <div className="space-y-2">
            ...
            <SingleExample english="They have already finished their homework." spanish="Ya han acabado sus deberes." />
            <SingleExample english="Jacob has already left work." spanish="Jacob ya se ha ido del trabajo." />
            <SingleExample english="The train has already arrived." spanish="El tren ya ha llegado." />
            ...
            />
            <SingleExample english="Where’s Jacob? He’s just left." spanish="¿Donde está Jacob? Acaba de irse." />
            <SingleExample
...
They still haven’t finished their homework."
            ...
            />
            <SingleExample english="Have they finished their homework yet?" spanish="¿Ya han terminado sus deberes?" />
            <SingleExample english="Has the train arrived yet?" spanish="¿Ya ha llegado el tren?" />
          </div>

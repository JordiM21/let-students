...
const Advanced = ({ levelData, userData }) => {
  ...
  return (
    <div className="bg-[var(--bluebg)] py-24">
      {level !== 'Intermediate' && level !== 'Advanced' && <LoadingScreen />}
      <BackHeader largeTitle="Advanced" parentTitle="Volver" />
      <div className="md:w-2/5 mx-auto space-y-4 mb-8 md:mx-8 max-md:w-10/12 md:fixed bg-[var(--bluebg)]">
        ...
        <h3 className="text-2xl font-bold text-white">
          Curso Avanzado de inglés para los que ya dominan la mayoría de conceptos de la lengua inglesa.
        </h3>
        <p className="text-[var(--lightBlue)] opacity-60">
          El curso avanzado es para los que dominan ya la lengua y pueden hablar y tener conversaciones fluidas, en este
          modulo perfeccionaremos esas frases y oraciones. Al finalizar este curso, el estudiante será capaz de formular
          oraciones mucho más complejas y comunicarse en inglés con mayor confianza.
        </p>
      </div>

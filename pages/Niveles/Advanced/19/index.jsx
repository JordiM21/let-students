      ...
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            />
            <CustomTitle title={"Each vs. Every"} titleSpanish={"“Each” y “every” son dos palabras que con frecuencia confunden los estudiantes de inglés. Ambas se traducen como “cada” y a veces, pueden significar lo mismo. Sin embargo, en otras ocasiones, hay una diferencia sutil en el sentido. Las dos se utilizan como determinantes para especificar cantidad, pero sólo “each” se puede utilizar como pronombre."} />
            <CustomTitle title={"Each"} titleSpanish={"“Each” enfatiza cada uno individualmente o por separado, como “uno por uno”. “Each” se puede utilizar delante de un verbo y se usa cuando se refiere a dos cosas o personas."} />
            <SingleExample
            ...
            />
            <SingleExample
              english="There are holes in each sock."
              spanish="Hay agujeros en cada calcetín."
            />
            <small className='text-sm opacity-60'>“Each” se puede usar con la preposición “of”. En esta construcción, “each of” va seguida por un pronombre o un sustantivo con un determinante.</small>
            <SingleExample
            ...
            />
            <CustomTitle title={"Every"} titleSpanish={"Mediante el uso de “every”, destacamos el grupo y sólo se puede utilizar con grupos de tres o más personas o cosas. “Every” se utiliza para generalizar o para expresar la frecuencia con que algo suceda y siempre va seguida de un sustantivo."} />
            <SingleExample
            ...
            />
            <SingleExample
              english="Almost every answer was incorrect."
              spanish="Casi cada respuesta era incorrecta."
            />
            <SingleExample

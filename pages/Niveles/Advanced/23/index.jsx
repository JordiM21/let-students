        ...
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            <SingleExample
              ...
              spanish="¿A qué hora es la reunión?"
            />
            ...
            />
            <CustomTitle title={"Steps to create Indirect Questions"} titleSpanish={"Pasos a seguir para crear correctamente preguntas indirectas"} />
            <p className='text-sm opacity-60'>1. Comenzamos con una palabra interrogativa como "what" (qué), "where" (dónde), "when" (cuándo), "who" (quién), "how" (cómo) o "why" (por qué).</p>
            <p className='text-sm opacity-60'>2. Luego, usamos un verbo introductorio como "ask," "tell," "wonder," "know," "explain," o "show."</p>
            <p className='text-sm opacity-60'>3. Finalmente, formamos la pregunta indirecta como una oración afirmativa, manteniendo el orden del sujeto y el verbo.</p>
            <p className='text-sm opacity-60'>¡Veamos algunos ejemplos!</p>
            <SingleExample
              english="Could you tell me where she lives?"
              spanish="¿Podrías decirme dónde vive ella?"
            />
            <SingleExample
            ...
            />
            <p className='text-sm opacity-60'>Es importante tener en cuenta que las preguntas indirectas suelen llevar una estructura más formal y educada, lo que puede ser especialmente útil en situaciones profesionales o en interacciones con personas que no conocemos bien. Con las preguntas indirectas, podemos expresar nuestras inquietudes o solicitar información de manera más amable y respetuosa.</p>
          </div>

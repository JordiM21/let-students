    ...
    <div className='bg-gray-100'>
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <ReactPlayer
          ...
          url="https://www.youtube.com/watch?v=wCPU_k1kBYg"
          controls={true} />
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            />
            <small className='text-sm opacity-60'>3. Interrogative Sentences (Frases interrogativas)
            </small>
            <SingleExample
            ...
            />
            <small className='text-sm opacity-60'>1. Utilizamos el futuro perfecto continuo para mostrar que algo va a continuar hasta otra acción o tiempo en el futuro.</small>
            <SingleExample
            ...
            />
            <small className='text-sm opacity-60'>2. El uso del futuro perfecto continuo es una manera de mostrar causa y efecto en el futuro.</small>
            <SingleExample

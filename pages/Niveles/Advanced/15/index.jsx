        ...
        <div className="my-4">
          <div className="space-y-2">
            <small className="text-sm opacity-60">
              Delexical verbs son verbos comunes como “have”, “take”, “make” o “give” que cuando se usan con sustantivos
              particulares tienen muy poco significado propio. En estas estructuras la mayor parte del significado se
              encuentra en el sustantivo, no en el verbo. En la mayoría de casos, hay un verbo que tiene un significado
              similar o igual a la estructura “delexical”. En muchos casos, hay verbos y estructuras equivalentes en
              español (ver los ejemplos). Estas estructuras son muy comunes en inglés y una comprensión de ellas
              enriquecerá la fluidez de la lengua.
            </small>
            <CustomTitle
              title={'Have'}
              titleSpanish={
            ...
            />
            <SingleExample english="Lets have a drink!" spanish="¡Tomemos una copa!" />
            <SingleExample english="They had an argument last night." spanish="Tuvieron una discusión anoche." />
            <SingleExample
            ...
            <CustomTitle
              title={'Take'}
              titleSpanish={'“Take”, como “have”, se usa con lavado o descansos, así como varios otros sustantivos.'}
            />
            <SingleExample
              english="I need to take a long, hot bath."
              spanish="Necesito tomar un baño largo y caliente."
            />
            <SingleExample english="Take a break, you look exhausted." spanish="Toma un descanso, te veo agotado." />
            <SingleExample english="Nancy doesn’t like to take risks." spanish="A Nancy no le gusta correr riesgos." />
            <SingleExample
              english="
Can you take care of my dogs while I am on vacation?"
            ...
            <CustomTitle
              title={'Make'}
              titleSpanish={'Utilizamos “make” con planes, viajes y en referencia a hablar.'}
            />
            <SingleExample
            ...
            />
            <SingleExample english="Go ahead, give it a kick!" spanish="Venga, dale una patada." />
            <CustomTitle
              title={'Go'}
              titleSpanish={
            ...
            />
            <SingleExample english="Beth goes swimming every day." spanish="Beth va a nadar todos los días." />
            <SingleExample english="Nina doesn’t like to go shopping." spanish="A Nina no le gusta ir de compras." />
            <SingleExample
            ...
            />
            <SingleExample english="Can you please do the washing?" spanish="¿Puedes hacer el lavado por favor?" />
            <SingleExample english="You rest, I’ll do the cooking today." spanish="Descansa, haré la comida hoy." />
            <SingleExample english="Let me help you do your hair." spanish="Déjame ayudarte a arreglar tu cabello." />
          </div>

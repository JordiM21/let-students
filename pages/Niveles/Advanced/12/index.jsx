      ...
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <div className="my-4">
          <div className="space-y-2">
            ...
            <SingleExample english="He ate all of the cookies." spanish="Comió todas las galletas." />
            <small className="text-sm opacity-60  underline">La voz pasiva</small>
            <SingleExample english="All of the cookies were eaten." spanish="Todas las galletas fueron comidas." />
            <SingleExample
              english="The speech is written for the president."
              spanish="El discurso está escrito para el presidente."
            />
            <SingleExample english="The house was built in 1975." spanish="La casa fue construida en 1975." />
            <SingleExample english="My wallet has been stolen." spanish="Ha sido robada mi cartera." />
            <SingleExample
            ...
            <p className="text-sm opacity-60  underline">La voz activa</p>
            <SingleExample english="Mark Twain wrote the book." spanish="Mark Twain escribió el libro." />
            <small className="text-sm opacity-60  underline">La voz pasiva</small>
            <SingleExample
            ...
            <SingleExample english="A civilian has been killed." spanish="Un civil ha sido asesinado." />
            <SingleExample english="The car was stolen." spanish="El coche fue robado." />
            <SingleExample english="The letter was delivered yesterday." spanish="La carta fue entregada ayer" />
            <SingleExample
              english="
A mistake was made."

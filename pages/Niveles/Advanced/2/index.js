    ...
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="font-bold text-gray-700">
          ...
          español, pero el uso de esta forma es más frecuente en inglés. Se utiliza para acciones que han empezado en el
...
Have you been waiting long?"
            ...
            <SingleExample english="He hasn’t been studying enough." spanish="No ha estado estudiando bastante." />
            <SingleExample english="Have you been feeling ok lately?" spanish="¿Te has sentido bien últimamente?" />
            <SingleExample

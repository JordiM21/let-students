    ...
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="font-bold text-gray-700">
          Los verbos modales, como vimos en la lección anterior, expresan posibilidad o probabilidad. Cuando se utilizan
          con la forma infinitiva del perfecto (“have” + participio pasado), los verbos modales indican especulación
        ...
        <div className="my-4">
          <div className="space-y-2">
            ...
            <small className="text-sm opacity-60">
              ...
              seguros de lo que sucedió exactamente, pero basándonos en las pruebas, podemos llegar a alguna conclusión.
...
Frank failed the exam. He must not have been paying attention in class."
            ...
            <small className="text-sm opacity-60">
              ...
              “can’t have” cuando estamos bastante seguros de que algo no ocurrió o que no fue verdad en el pasado.
            </small>
            <SingleExample
              english="

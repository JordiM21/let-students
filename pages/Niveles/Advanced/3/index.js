      ...
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <div className='my-4'>
          ...
          <div className='space-y-2'>
            ...
            <small className='text-sm opacity-60'>PASADO SIMPLE (EJEMPLOS)</small>
            <SingleExample
              english="I went to Cuba last year."
              spanish="Fui a Cuba el año pasado."
            />
            <SingleExample
              english="They saw a movie yesterday."
              spanish="Vieron una película ayer."
            />
            <small className='text-sm opacity-60'>PRESENTE PERFECTO (EJEMPLOS)</small>
            <SingleExample
            ...
            />
            <SingleExample
              english="They have seen a movie."
              spanish="Ellos han visto una pelicula."
            />
            <SingleExample
              english="(INCORRECTO) They have seen yesterday a movie"
              spanish="No es correcta, porque?"
            />

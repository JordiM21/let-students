    ...
    <div className="bg-gray-100">
      <div className="mx-6 md:max-w-xl md:mx-auto">
        ...
        <p className="font-bold text-gray-700">
          ...
          indicativo del verbo “estar” y el verbo+ing. En general, lo usamos para acciones en proceso de realización en
          el pasado antes de otra acción ocurrida.
        </p>
        <div className="my-4">
...
They had not [hadn’t] been traveling long before they had their first problem."
            ...
            <small className="text-sm opacity-60">
              Usamos el pasado perfecto continuo para referirnos a algo que habíamos estado haciendo (en proceso) cuando
              otra acción lo interrumpió. El pasado perfecto continuo se utiliza para la acción en proceso y el pasado
              simple para la acción que interrumpe. Cuando nos referimos a algo que hemos estado haciendo en un período
              de tiempo, por lo tanto, solemos usar las preposiciones de tiempo “for” o “since”.
            </small>
            <SingleExample

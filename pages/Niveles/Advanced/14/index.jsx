        ...
        <div className="my-4">
          <div className="space-y-2">
            <small className="text-sm opacity-60">
              ...
              “hacer”, pero hay algunas diferencias en su significado. En general, “do” considera más la acción,
            ...
            />
            <SingleExample english="Do the homework" spanish="Hacer la tarea" />
            <SingleExample english="Do the Dishes" spanish="Hacer los platos (Lavarlos)" />
            <SingleExample english="Do exercise" spanish="Hacer ejercicio" />
            <SingleExample
            ...
            />
            <SingleExample english="make a decision" spanish="tomar una decisión" />
            <SingleExample english="make a choice" spanish="hacer una elección" />
            <SingleExample english="make a plan" spanish="trazar/hacer un plan" />
            <SingleExample english="make an appointment" spanish="pedir cita/hora, concertar una cita" />
            <SingleExample english="make a mistake" spanish="cometer un error" />
            <SingleExample english="make money" spanish="ganar dinero" />
            <SingleExample english="make an effort" spanish="hacer un esfuerzo" />
            <SingleExample english="make fun of" spanish="reírse/burlarse de" />
            <SingleExample english="make [a] noise" spanish="hacer [un] ruido" />
            <SingleExample english="make peace" spanish="firmar la paz" />
            <SingleExample english="make a phone call" spanish="hacer una llamada" />
            <SingleExample english="make a change" spanish="hacer un cambio" />
          </div>

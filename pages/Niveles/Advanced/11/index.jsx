        ...
        <div className="my-4">
          <div className="space-y-2">
            <small className="text-sm opacity-60">
              ...
              sobre situaciones reales o irreales. En general, las frases condicionales llevan la palabra “if” (si). Ten
              en cuenta que no existe un tiempo verbal para el condicional en inglés como existe en español. A la vez,
              se usa el verbo auxiliar “would” para formar el condicional en inglés. Hay cuatro tipos de frases
              condicionales y el uso de uno u otro refleja la probabilidad de la acción.
            </small>
            <CustomTitle
              title={'Zero Conditional (Tipo 0)'}
              titleSpanish={
            ...
            <SingleExample english="if + present simple + present simple" spanish="id + condition + result" />
            ...
            />
            <CustomTitle
              title={'First Conditional (Tipo 1)'}
              titleSpanish={
            ...
            <ReactPlayer
              ...
              controls={true}
            />
            <SingleExample english="if + present simple + will" spanish="if + condfition + result" />
            <small className="text-sm opacity-60">EJEMPLOS</small>
            <SingleExample
            ...
            />
            <CustomTitle
              title={'Second Conditional (Tipo 2)'}
              titleSpanish={
            ...
            <ReactPlayer
              ...
              controls={true}
            />
            <SingleExample english="if + past simple + would + infinitivo" spanish="if + condition + result" />
            <SingleExample
            ...
            />
            <CustomTitle
              title={'Third Conditional (Tipo 3)'}
              titleSpanish={

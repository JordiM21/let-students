    ...
    <div className='bg-gray-100'>
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <ReactPlayer
          ...
          url="https://www.youtube.com/watch?v=7aw7bQtPYCE"
          controls={true} />
        <p className='font-bold text-gray-700'>El presente perfecto equivale más o menos al pretérito perfecto del español. Veremos las diferencias en la sección sobre usos. En general, es una mezcla entre el presente y el pasado. Lo usamos para acciones en el pasado que tienen importancia en el presente.</p>
        <div className='my-4'>
...
I have [I’ve] talked to Peter."
            ...
            />
            <SingleExample
              english="She has [She’s] gone to work."
              spanish="Ha ido a su trabajo."
            />
            <SingleExample
              english="We have [We’ve] been to London."
              spanish="Hemos ido a Londres."
            />
            <SingleExample
              english="They have [They’ve] learned English."
              spanish="Han aprendido inglés."
            />
...
I haven’t talked to Peter."
            ...
            />
            <SingleExample
              english="She hasn’t gone to work."
              spanish="No ha ido a su trabajo."
            />
            <SingleExample
              english="We haven’t been to London."
              spanish="No hemos ido a Londres."
            />
            <SingleExample
              english="They haven’t learned English."
              spanish="No han aprendido inglés."
            />
            <small className='text-sm opacity-60'>Interrogative Sentences (Frases Interrogativas)</small>
            <SingleExample
              english="Have you talked to Peter?"
              spanish="¿Has hablado con Peter?"
            />
            <SingleExample
              english="
Has she gone to work?"
            ...
            <SingleExample
              ...
              spanish="¿Has ido a Londres?"
            />
            <SingleExample
              english="Have they learned English?"
              spanish="¿Han aprendido inglés?"
            />
            <small className='text-sm opacity-60'>Ejemplos prácticos</small>
            <SingleExample
              english="I have never flown in a plane."
              spanish="Nunca he volado en un avión."
            />
            <SingleExample
...
I have become more timid in my old age."
            ...
            />
            <SingleExample
              english="He has learned to be more patient."
              spanish="Ha aprendido a ser más paciente."
            />
            <SingleExample
              english="
Our football team has won the championship three times."
            ...
            />
            <SingleExample
              english="The plane hasn’t arrived yet."
              spanish="El avión no ha llegado todavía."
            />
            <SingleExample

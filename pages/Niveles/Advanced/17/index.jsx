      ...
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <div className='my-4'>
          <div className='space-y-2'>
            ...
            />
            <p className='text-sm opacity-60'>Los verbos compuestos pueden ser transitivos o intransitivos, según lleven o no, un complemento de objeto directo en forma de sintagma nominal. De ello dependerá el orden de la frase.</p>
            <p className='text-sm opacity-60'>No vamos a fijarnos en las diferencias entre los diferentes tipos de verbos compuestos. Por ahora, lo que es más importante es tener en cuenta que los verbos frasales y preposicionales son verbos y en general tienen significados distintos de los verbos que los forman.</p>
            <p className='text-sm opacity-60'>Por ejemplo, el verbo “give” significa “dar”, pero si añadimos la preposición “up”, el significado cambiará: “Give up” significa “abandonar”, “dejar de” o “rendirse”. Por lo tanto, “give” y “give up” son dos verbos distintos.</p>
          </div>

    ...
    <div className='bg-gray-100'>
      <div className='mx-6 md:max-w-xl md:mx-auto'>
        ...
        <ReactPlayer
          ...
          url="https://www.youtube.com/watch?v=kGv_mGUCFJE"
          controls={true} />
        <div className='my-4'>
          <div className='space-y-2'>
            <p className='text-sm opacity-60'>El condicional perfecto en inglés se forma usando "would have" seguido del participio pasado de un verbo. Se utiliza para hablar acerca de situaciones hipotéticas en el pasado, es decir, para expresar acciones que podrían haber ocurrido, pero que en realidad no sucedieron.</p>
            <p className='text-sm opacity-60'>Para formar el condicional perfecto, utilizamos la siguiente estructura:
              Sujeto + would have + participio pasado del verbo</p>
            <SingleExample
            ...
            />
            <p className='text-sm opacity-60'>Recuerda que el condicional perfecto siempre se refiere a situaciones hipotéticas en el pasado que no ocurrieron, pero que podrían haber sucedido si las condiciones hubieran sido diferentes.</p>
          </div>

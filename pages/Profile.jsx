          ...
          <>
            ...
            <div className="flex justify-around md:w-1/2 md:mx-auto">
              <div className="w-full">
                ...
                >
                  ...
                  <div style={{ fontSize: '.95rem' }} className="text">
                    Logout
                  </div>
                </button>
              </div>
            ...
            <div>
              ...
              >
                <Box sx={style}>
                  <iframe
                    src="https://docs.google.com/forms/d/e/1FAIpQLSfyFF63RLIe1vl0zewGgM9AL5_K1diq56x6Xqsf6Ab19VwCZA/viewform?embedded=true"
                    width="100%"
                    height="500px"
                    frameborder="0"
                    marginheight="0"

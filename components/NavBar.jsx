    ...
    <>
      ...
      <div className='bg-gray-900 bg-opacity-40 px-1 py-4 backdrop-blur-md fixed left-0 h-full max-md:hidden z-50 w-[50px] flex gap-2 flex-col'>
        ...
        <div onClick={() => router.push("/Immersive")} className={`bg-yellow-400/90 group p-1 hover:shadow-md hover:shadow-yellow-700 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-lg ${router.pathname == "/Immersive" && "scale-110 translate-x-2 border-2"}`}>
          ...
          <p className='text-gray-700 text-[16px] absolute bottom-1 opacity-0 group-hover:opacity-100 font-bold -right-[84px] rounded-lg px-3 bg-slate-300 shadow-md bg-opacity-95 shadow-black'>Videos</p>
        </div>
      ...
      <div className='flex justify-center'>
        <div className='bg-slate-100 z-50 bg-opacity-30 backdrop-blur-xl fixed py-2 px-2 justify-around rounded-2xl bottom-3 md:hidden max-md:flex w-10/12'>
          <div onClick={() => router.push("/Dashboard")} className={`bg-red-500 group p-3 hover:shadow-md hover:shadow-red-900 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-2xl ${router.pathname == "/Dashboard" && "scale-110 -translate-y-2 border-2 opacity-90"}`}>
          ...
          <div onClick={() => router.push("/Niveles")} className={`bg-orange-500/95 group p-3 hover:shadow-md hover:shadow-orange-800 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-2xl ${router.pathname == "/Niveles" && "scale-110 -translate-y-2 border-2 opacity-90"}`}>
          ...
          <div onClick={() => router.push("/Immersive")} className={`bg-yellow-400/90 group p-3 hover:shadow-md hover:shadow-yellow-700 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-2xl ${router.pathname == "/Immersive" && "scale-110 -translate-y-2 border-2 opacity-90"}`}>
          ...
          <div onClick={() => router.push("/Progress")} className={`bg-green-500/90 group p-3 hover:shadow-md hover:shadow-green-900 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-2xl ${router.pathname == "/Progress" && "scale-110 translate-x-2 border-2"}`}>
          ...
          <div onClick={() => router.push("/Profile")} className={`bg-blue-500 group p-3 hover:shadow-md hover:shadow-blue-900 cursor-pointer transition-all hover:scale-110 duration-150 active:scale-95 active:opacity-80 ease-in rounded-2xl  ${router.pathname == "/Profile" && "scale-110 -translate-y-2 border-2 opacity-90"}`}>

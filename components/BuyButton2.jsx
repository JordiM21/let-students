    ...
    const loadBuyButton = () => {
      ...
      if (!document.querySelector('script[src="https://js.stripe.com/v3/buy-button.js"]')) {
        ...
        script.onload = () => {
          ...
          stripeBuyButton.setAttribute('buy-button-id', 'buy_btn_1PMUJsBjLDLVBoAyn0CYijd4');
          stripeBuyButton.setAttribute('publishable-key', 'pk_live_51NYA5oBjLDLVBoAyxLUTxwdvl60uIrTsKAeruXWEGSTwyPH7O4xASxGWXqfnSMst1B0Ba2n0nNqlyQlceCTdt9Mf00QbSeCsVd');
